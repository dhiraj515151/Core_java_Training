...
public class App 
{
    public static void main( String[] args ) throws IOException, SQLException
    {
   	...
   	int choice=-1;
   	String uId = null,firstName,lastName,email=null;
   	do {
   		...
   		switch (choice) {
			...
			case 4:
					...
					int i = service.updateCustomerById(Id, cname);
			...
			case 5:
					...
					int i2 = service.deleteCustomer(uId);
					System.out.println("Deletion Successful. "+i2);
